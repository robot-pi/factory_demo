...
def generate_launch_description():
  ...
  world_file_path = 'worlds/AI_trainning_scenario.world' # Example: 'worlds/house_classic.world', 'worlds/empty_classic.world', 'worlds/small_warehouse_classic.world', 'world/AI_trainning_scenario.world'

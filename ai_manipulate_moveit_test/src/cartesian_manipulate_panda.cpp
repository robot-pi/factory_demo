...
int main(int argc, char * argv[])
{
  ...
  arm_group_interface.setEndEffectorLink("end_effector_frame");  // Replace "end_effector_link" with your actual end-effector link name

  // Set the initial pose as the starting point for Cartesian path planning
  geometry_msgs::msg::PoseStamped start_pose = arm_group_interface.getCurrentPose("end_effector_frame");

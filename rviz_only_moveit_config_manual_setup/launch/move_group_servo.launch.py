...
def launch_setup(context, *args, **kwargs):
    ...
    rviz_config_file = (
    get_package_share_directory("rviz_only_moveit_config_manual_setup") + "/rviz/move_group_servo.rviz"
    )
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
    ...
    move_group_node = Node(
        ...
        remappings=[
                ('/joint_states', '/servo_node/joint_states'),
                ('/attached_collision_objects', '/servo_node/attached_collision_objects'),
                ('/planning_scene_world', '/servo_node/planning_scene_world'),
                ('/collision_object', '/servo_node/collision_object')
            ]
    )
